    ...
    <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-4 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-400 mt-7">
              A robust and feature rich cloud based school management aplication
              that allows school managers effectively manage their schools
              remotely from anywhere with tools for teachers to teach and
              students to learn online anywhere.
            </p>
        ...
        <p className="text-sm text-center text-gray-600">
          © Copyright 2024, All Rights Reserved by IMT
        </p>
      </div>
    </section>
  );
